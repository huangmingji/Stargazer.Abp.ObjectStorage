...
{
    public class DownloadService : ApplicationService, IDownloadService
    {
        private readonly IBlobContainer<DownloadContainer> _blobContainer;

        public DownloadService(IBlobContainer<DownloadContainer> blobContainer)
        {
